        ...
        <template #default="{ fileList }">
          <div class="file-panel" style="background: #131314;" :class="{ collapse: collapse }">
            <div class="file-title" @click="collapse = !collapse">
              <div class="title" style="color:#777777;font-size: 15px" >传输列表</div>
              <div class="operate">
...
<!--                <svg link @click="close" fill="currentColor" width="17" height="17" style="color:#3f3f3f;cursor: pointer;margin-left: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">&lt;!&ndash;! Font Awesome Pro 6.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. &ndash;&gt;<path d="M315.3 411.3c-6.253 6.253-16.37 6.253-22.63 0L160 278.6l-132.7 132.7c-6.253 6.253-16.37 6.253-22.63 0c-6.253-6.253-6.253-16.37 0-22.63L137.4 256L4.69 123.3c-6.253-6.253-6.253-16.37 0-22.63c6.253-6.253 16.37-6.253 22.63 0L160 233.4l132.7-132.7c6.253-6.253 16.37-6.253 22.63 0c6.253 6.253 6.253 16.37 0 22.63L182.6 256l132.7 132.7C321.6 394.9 321.6 405.1 315.3 411.3z"/></svg>-->
              </div>
            </div>
